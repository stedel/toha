...
(function ($) {
    jQuery(document).ready(function () {
        ...
        function showangebotes() {
            // show angebotes from angebotes-holder div
            let gallery = document.getElementById("gallery");
            if (gallery == null) {
                return
            }
            gallery.innerHTML = "";
            const entries = document.getElementById("angebotes-holder").children;
            ...
            let elements = document.getElementsByClassName("angebote-entry");
            len = elements.length;
            for (let i = 0; i < len; i++) {
                elements[i].onclick = function () {
                    let angebotes = document.getElementsByClassName("angebote-entry");
                    let len2 = angebotes.length;
                    for (let j = 0; j < len2; j++) {
                        angebotes[j].classList.toggle("hidden");
                    }
                    this.classList.toggle("angebote-details");
                    ...
                    if (this.children["angebote-title"] != undefined) {
                        this.children["angebote-title"].classList.toggle("hidden");
                    }
                }
            }
        }
